module.exports = {
    // All tables that should be created in the database on init
    // If a new table is added, it will be created.
    // Otherwise, if it already exists, it will not be created.
    default_tables: [
        {
        ...
        },
        {
            ...
            name: 'charts',
            structure: `(id INTEGER PRIMARY KEY AUTO_INCREMENT, 
                        title VARCHAR(40), 
                        song_artist VARCHAR(40), 
                        choreography VARCHAR(40), 
