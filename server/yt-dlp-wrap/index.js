// Wrapper adapted from https://www.npmjs.com/package/youtube-dl-wrap
// to work with https://github.com/yt-dlp/yt-dlp
...
class YoutubeDlWrap
{
    ...
    {
        let fileName = platform == "win32" ? "yt-dlp.exe" : "yt-dlp";
        if(!version)
