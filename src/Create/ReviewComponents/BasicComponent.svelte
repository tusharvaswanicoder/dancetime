<script>
    ...
    export let title = '';
    export let borderColor = 'var(--color-red-light)';
...
<main class={`background`} class:selected style={`--color-border: ${borderColor}`}>
...
<style>
    main.background {
        ...
        background-color: var(--color-border, var(--color-gray-500));
    ...
    /* main.background.selected {
        --background-color1: var(--color-red-dark);
        --background-color2: var(--color-red-light);
    } */
